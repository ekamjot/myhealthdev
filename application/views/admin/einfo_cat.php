            ...
            <div class="box-inner">
                ...
                <div class="box-header well" data-original-title="">
                    ...
                    <div style="float:right;">	
						<a href="#" data-toggle="modal" data-target="#add_location" class="btn btn-info btn-sm">Add Filters</a>
					</div>
...
<div class="modal fade" id="add_location" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content"> 
		<form method="post" action=<?php echo base_url().'admin/add_einfo_cat'; ?>>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Add E-info Cat</h4>
      </div>
